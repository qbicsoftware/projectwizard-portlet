...
import life.qbic.datamodel.entities.OpenbisMSSample;
...
import life.qbic.portlet.uicomponents.EnzymePanel;
import life.qbic.portlet.uicomponents.MSSampleMultiplicationTable;
import life.qbic.portlet.uicomponents.SampleSelectComponent;
            ...
            private void showSampleSelectInfo() {
              if (!selectInfoWasShown) {
                Styles.notification("Sample Selection",
                    ...
                    life.qbic.portlet.Styles.NotificationType.DEFAULT);
