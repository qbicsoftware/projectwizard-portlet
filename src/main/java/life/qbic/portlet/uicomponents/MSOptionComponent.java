...
import life.qbic.portlet.steps.MSAnalyteStep;
...
public class MSOptionComponent extends VerticalLayout {
  ...
  public List<WizardStep> getNextMSSteps(Map<life.qbic.portlet.control.WizardController.Steps, WizardStep> steps) {
