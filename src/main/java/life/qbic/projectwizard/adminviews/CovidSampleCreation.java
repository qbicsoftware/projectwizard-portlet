...
public class CovidSampleCreation implements IRegistrationView, IRegistrationController {
  ...
  private ISampleBean generatePatient(String experimentCode, String projectCode, String space, String patientNumber) {
    String secondaryName = "Patient "+patientNumber;
    String code = project+"ENTITY-"+patientNumber;
    TSVSampleBean b = new TSVSampleBean(code, exp, proj, space, SampleType.Q_BIOLOGICAL_ENTITY, secondaryName, parentIDs, metadata)
  }
  
  private ISampleBean generateTissue(ISampleBean parent, String experimentCode, String projectCode, String space, String patientNumber) {
  ...
  //
//  P001:RA:T0:A1(:DNA)
//  RA: Rachenabstrich / Throat (oral) swab
//  ST: Stuhl / Faeces
//  SE: Serum
//  PB: PBMC
//  PL: PLASMA
//  PA: PAX Gene Blood RNA
//  UR: Urine
  ...
  //
  // Tropical Medicine: Heparin PBMCs, Plasma, Serum
  //
  // It is still unclear, when we receive the information for Kit 2
  //
  // Rachenabstrich: 2 ml medium geht in vier Aliquots, bzw. Vielleicht am besten immer 10
  // Stuhl: Stuhlröhrchen, wird nicht aliquotiert, sondern wird als eine Probe eingefroren
  // Urin: wird auf jeden Fall auch gesammelt (im Rahmen der nationalen Kohorte)


  public CovidSampleCreation(IOpenBisClient openbis, IOpenbisCreationController creationController,
      String user) {
  ...
  protected CovidSampleCreation getView() {
    return this;
  }
