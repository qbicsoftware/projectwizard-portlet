...
/**
 * Entry point for portlet ProjectWizard_Portlet. This class derives from {@link QBiCPortletUI}, which is found in the {@code portal-utils-lib} library.
 *
...
@Log4j2
@CompileStatic
class ProjectWizardPortlet extends QBiCPortletUI {
